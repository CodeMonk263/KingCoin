...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = USER_NAME, amount = 1)
...
def add_transaction():
    ...
    index = blockchain.add_transaction(USER_NAME, json['receiver'], json['amount'])
...
def connect_node():
    ...
    response = {'message': 'All the nodes are now connected. KingCoin Blockchain now contains the following nodes:',
