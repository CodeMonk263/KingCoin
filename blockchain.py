...
class BlockChain:
    ...
    def proof_of_work(self, previous_proof):
        ...
        while check_proof is False:
            # Problems that miners have to solve -
            # operation has to be non-symmetrical
...
def mine_block():
    ...
    mined_block = blockchain.create_block(proof, previous_hash)
    response = {
...
def check_valid():
    ...
    if is_valid:
        ...
        response = {'message' : 'Blockchain is compromised'}
    return jsonify(response), 200
